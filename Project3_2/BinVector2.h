...
public:
	...
	friend std::ostream & operator << (std::ostream &c, BinVector &b);
...
int Get_info(number& a, int flag_for_int)
{
	...
	if (dop.length() > 20) throw std::out_of_range("Длина введённой строки больше возможного допустимого значения");
